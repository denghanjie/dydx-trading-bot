...
class BotAgent:
    ...
    def open_trades(self):
        ...
        try:
            ...
            print("Error at placing base market order.")
            print(f"Market 1 {self.market_1}: ,{e}")
        ...
        if order_status_m1 != "live":
            ...
            print("Error at filling base market order.")
        ...
        try:
            ...
            print("Error at placing quote market order")
            print(f"Market 2 {self.market_2}: ,{e}")
            return self.order_dict
        ...
        if order_status_m2 != "live":
            ...
            try:
                ...
                if order_status_close_order != "FILLED":
                    print("ABORT PROGRAM")
                    print("Unexpected Error, Market 2 Order Not Filled.")
                ...
                self.order_dict["comments"] = f"Market 2 {self.market_2}: ,{e}"
                print("ABORT PROGRAM")
                print("Unexpected Error, at closing first order.")
                print(f"Market 2 {self.market_2}: ,{e}")
